...
function LoginCard(props) {
	return (
		<div className='login-card'>
			<div className='credentials'><span className='user jetbrains-mono-regular-400'>[{'>'}_] {props.username}</span> <span className='score jetbrains-mono-regular-400'>[!] {props.userscore}/{props.totalscore}</span></div>
